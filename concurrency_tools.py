# ---------------------------------------------------------------------------
# Part of `tools-patched`: a vendored copy of two modules from Andrew G. York's
# `tools` repo (https://github.com/AndrewGYork/tools), GPL-2.0.
#
# File: concurrency_tools.py
# Original authors: Nathaniel H. Thayer and Andrew G. York.
# UNMODIFIED upstream snapshot (dated ~2024-05-31). Upstream has since changed;
# see https://github.com/AndrewGYork/tools/commits/master/concurrency_tools.py
# If/when this file is patched, record the change here and in PATCHES.md.
